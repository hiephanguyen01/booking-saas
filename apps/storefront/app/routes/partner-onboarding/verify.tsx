...
import { requirePartnerPhase, verifyPartnerRegistration, type PartnerOnboardingActionData } from '../../lib/partner-onboarding.server';
...
export const loader = ({ request, params }: Route.LoaderArgs) => requirePartnerPhase(request, 'partner_registration_verify', params.locale);
...
export default function PartnerVerify() {
  ...
  return (
    <AuthSplit>
      <FormHeading title="Xác thực email" description={<>Mã xác thực đã được gửi tới <strong className="font-semibold text-[#344054]">{loaderData.record.maskedDestination}</strong></>} />
