...
import { loadRegisterRoute, startRegistrationAction } from '~/features/auth/server/auth-routes.server';
...
export const loader = ({ request, params }: Route.LoaderArgs) =>
  loadRegisterRoute(request, params.locale);
  ...
  return (
    ...
    >
      <StartForm
        ...
        legalConsent={loaderData.legalConsent}
      />
      <SocialButtons />
