...
describe('RejectManualRefundUseCase', () => {
  ...
  it('rejects with MANUAL_REFUND_WORKFLOW_PAUSED when workflow is paused', async () => {
    ...
    const useCase = new RejectManualRefundUseCase(
    ...
    await expect(
      useCase.execute(
        ...
        { expectedVersion: 3, reason: 'Receipt is unreadable' },
