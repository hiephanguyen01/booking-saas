...
export function toManualRefundListItem(
  ...
  const status = toCustomerManualRefundStatusResponse(
    operation,
    {
  ...
  return {
    id: status.id,
    refundBatchId: status.refundBatchId,
    bookingId: status.bookingId,
    bookingCode: status.bookingCode,
    amount: status.amount,
    status: status.status,
    version: status.version,
    destinationLocked: status.destinationLocked,
    destination: status.destination,
    verificationResult: status.verificationResult,
    transferDueAt: status.transferDueAt,
    customerDetailsDueAt: status.customerDetailsDueAt,
    transferSubmittedAt: status.transferSubmittedAt,
