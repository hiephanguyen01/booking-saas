...
async function upsertStudioGroup(
  ...
  const data = {
    ...
    amenities: [
      { label: 'Lễ tân', icon: 'Bell' },
      { label: 'Chỗ đậu xe', icon: 'Car' },
      { label: 'Máy lạnh', icon: 'AirVent' },
      { label: 'Phòng thay đồ', icon: 'DoorOpen' },
      { label: 'Khu makeup', icon: 'Sparkles' },
      { label: 'Wi-Fi tốc độ cao', icon: 'Wifi' },
    ],
    status,
