export const viCheckout = {
  ...
  login: 'Đăng nhập',
  register: 'Đăng ký',
  promotions: 'Ưu đãi thanh toán dành cho bạn',
  ...
  promoRemove: 'Bỏ mã',
  promoDialog: {
    title: 'Chọn ưu đãi thanh toán',
    description:
      'Nhập mã hoặc chọn một ưu đãi phù hợp. Ưu đãi thanh toán được áp dụng sau giá ưu đãi theo lịch.',
