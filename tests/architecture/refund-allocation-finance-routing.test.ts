...
import { OutboxHandlerRegistry } from '../../apps/api/src/shared/outbox/outbox-handler.registry';
import type { OutboxEventRecord } from '../../apps/api/src/shared/outbox/outbox.types';
import { FinanceModule } from '../../apps/api/src/modules/finance/infrastructure/http/finance.module';
